...
export default function Book105Page() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-neutral-950 px-2 py-6 relative overflow-hidden">
      ...
      >
        <div className="flex items-center mb-2">
          <span className="vhs-label vhs-glitch" data-text="#105">#105</span>
          <span className="vhs-sub vhs-glitch" data-text="Egyedi, dedikált példány, amit még ma átvehetsz">Egyedi, dedikált példány</span>
        </div>
        ...
        <button
          ...
          className="vhs-cta"
        >
          {loading ? "Kaland indítása..." : "Kaland Indul"}
        </button>
