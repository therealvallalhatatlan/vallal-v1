import { Story } from "@/components/ReaderApp";

export const storiesMeta: Array<Omit<Story, "text">> = [
  {
    id: "00",
    slug: "konyvborito",
    title: "Könyvborító",
