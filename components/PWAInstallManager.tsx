            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-md border border-neutral-700 px-3 py-2 text-xs text-gray-200"
                >
        ...
        <div className="fixed left-4 right-4 bottom-6 z-50 max-w-3xl mx-auto">
          <div className="rounded-xl border border-neutral-800 bg-neutral-900/95 p-4 shadow-lg backdrop-blur-sm text-sm text-white flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex gap-2">
                <button onClick={openInExternal} className="rounded-md bg-lime-500 px-3 py-2 text-xs font-semibold text-black">
                  Megnyitás külső böngészőben
                </button>
