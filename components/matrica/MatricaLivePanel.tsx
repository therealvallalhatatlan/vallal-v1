    ...
    <>
      ...
      <section
        style={{
          ...
          borderRadius: 0,
          overflow: 'hidden',
          borderLeft: '1px solid rgba(190,242,100,0.28)',
      ...
      >
        ...
        >
          <button
            ...
            style={{
              border: activeTab === 'chat' ? '1px solid rgba(190,242,100,0.42)' : '1px solid rgba(255,255,255,0.15)',
              background: activeTab === 'chat' ? 'rgba(163,230,53,0.12)' : 'transparent',
              color: activeTab === 'chat' ? '#ecfccb' : '#d4d4d8',
              fontSize: 12,
              fontWeight: 700,
              padding: '5px 12px',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              border: activeTab === 'activity' ? '1px solid rgba(190,242,100,0.42)' : '1px solid rgba(255,255,255,0.15)',
              background: activeTab === 'activity' ? 'rgba(163,230,53,0.12)' : 'transparent',
              color: activeTab === 'activity' ? '#ecfccb' : '#d4d4d8',
              fontSize: 12,
              fontWeight: 700,
              padding: '5px 12px',
              cursor: 'pointer',
