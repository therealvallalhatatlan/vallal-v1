      ...
      <div className="p-5 md:p-6 bg-transparent border border-zinc-800 rounded-3xl">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-4">
          ...
          <div className="flex items-center gap-2 self-start md:self-auto">
            ...
            <button
              onClick={toggle}
              className="h-9 px-5 rounded-full border border-neutral-300 bg-neutral-200 hover:bg-neutral-300 text-neutral-900 text-sm font-semibold flex items-center justify-center transition-colors"
        ...
        {/* Rejtett megosztás / letöltés panel */}
        <div className="mt-3">
          <button
            type="button"
            onClick={toggleTools}
            ...
            <div className="px-1">
              <div className="flex items-center gap-2 overflow-x-auto whitespace-nowrap">
                <a
                  ...
                  className="px-3 py-1.5 rounded-full text-[11px] border border-zinc-700 bg-zinc-950 hover:bg-zinc-900 text-zinc-200"
                >⬇ MP3 Letöltés</a>
                <span className="text-[10px] text-zinc-500">külső platform:</span>
                <button
                  type="button"
                  onClick={() => handleOpenPlatform('youtube')}
                  className="px-3 py-1.5 rounded-full text-[10px] border border-red-500/60 bg-red-500/10 hover:bg-red-500/20 text-red-200"
                >YouTube</button>
                <button
                  type="button"
                  onClick={() => handleOpenPlatform('spotify')}
                  className="px-3 py-1.5 rounded-full text-[10px] border border-emerald-500/60 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-200"
                >Spotify</button>
                <button
                  type="button"
                  onClick={() => handleOpenPlatform('google')}
                  className="px-3 py-1.5 rounded-full text-[10px] border border-zinc-600 bg-zinc-950 hover:bg-zinc-900 text-zinc-100"
                >Google</button>
              </div>
